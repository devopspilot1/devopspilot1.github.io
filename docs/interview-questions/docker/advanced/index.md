...
#### Explain the concept of Namespaces and Cgroups in Docker.
...
#### What is a Multi-Stage Build? key benefits?
...
#### What is the Docker Daemon socket and why is it a security risk?
...
#### How do you debug a container that keeps crashing immediately?
...
#### Explain the `overlay2` storage driver.
...
#### What is an "init" process in Docker and why might you need it?
...
#### How do you upgrade a Docker Swarm cluster with zero downtime?
...
#### What are "multihost" networks in Docker?
