...
![Docker Port Mapping Diagram](../../images/docker-guided-port-mapping-diagram.png){: style="max-width:600px; display:block; margin:0 auto;" }
...
![Docker Dynamic Port Mapping Diagram](../../images/docker-guided-dynamic-port-mapping-diagram.png){: style="max-width:600px; display:block; margin:0 auto;" }
